...
const Preview = () => {
  ...
  const { photoData, selectedFilter, textOptions } = location.state || {};
  
  useEffect(() => {
    if (!photoData || !selectedFilter || !textOptions) {
      navigate('/camera');
      return;
    }
    
    renderFinalImage();
  }, [photoData, selectedFilter, textOptions, navigate]);
  ...
  const handleDownload = () => {
    ...
    try {
      ...
      link.download = 'glowupstudio_selfie.jpg';
        ...
        <div className="flex items-center mb-4">
          <button 
            onClick={() => navigate('/text', { 
              state: { photoData, selectedFilter } 
            })}
        ...
        >
          <div className="flex flex-col md:flex-row gap-4">
            <button
              ...
              className="bg-yellow-300 hover:bg-yellow-400 text-gray-900 font-bold py-3 px-6 rounded-full flex items-center justify-center flex-1"
            >
              {isDownloading ? (
            ...
            <button
              ...
              className={`font-bold py-3 px-6 rounded-full flex items-center justify-center flex-1 ${
                showEmailForm 
